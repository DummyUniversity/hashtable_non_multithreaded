...
The hashtable consists of an `std::vector` of `std::list <std::string>*`. The hashtable does not allow duplicates; on each insertion, it checks if the string does not already exist and only then inserts the string.
